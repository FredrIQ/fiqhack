...
overriden by tilesets that come later; if a tileset consists of
...
or specifying colors as separate red/blue/green/alpha channels (which
...
=item B<-b> I<red> I<blue> I<green>

Interprets any color in the input files with exactly the given
red/blue/green channels as fully transparent, regardless of its alpha.
...
For an image-based tileset, the images wil be converted to a textual
...
L<nethack4(6)>, L<http://nethack4.org>.
