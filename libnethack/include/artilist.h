...
# define     ALL_MTYP  {MTYP_ALL, 1}
# define     NO_MTYP   {MTYP_ALL, 0}
# define     MTYP(a,b)  {a,b}
...
/*  dummy element #0, so that all interesting indices are non-zero */
    A("", STRANGE_OBJECT,
      0, 0, NO_MTYP, NO_ATTK, NO_DFNS, NO_CARY, 0, A_NONE, NON_PM, NON_PM, 0L),
 ...
 */
    ...
    A("Excalibur", LONG_SWORD,
      (SPFX_NOGEN | SPFX_RESTR | SPFX_INTEL), 0, ALL_MTYP,
 ...
 */
    A("Stormbringer", RUNESWORD,
      (SPFX_RESTR | SPFX_INTEL), 0, ALL_MTYP,
 ...
 */
    ...
    A("Dragonbane", LANCE,
      SPFX_RESTR | SPFX_REFLECT | SPFX_WARNMON | SPFX_WTREDUC, 0,
      MTYP(MTYP_S, S_DRAGON),
 ...
 */
    A("Vorpal Blade", LONG_SWORD,
      (SPFX_RESTR | SPFX_BEHEAD), 0, ALL_MTYP,
 ...
 */
    A("Snickersnee", KATANA,
      SPFX_RESTR | SPFX_FREEACT, 0, ALL_MTYP,
 ...
 */
    ...
    A("The Orb of Detection", CRYSTAL_BALL,
      (SPFX_NOGEN | SPFX_RESTR | SPFX_INTEL), (SPFX_ESP | SPFX_HSPDAM), NO_MTYP,
      NO_ATTK, NO_DFNS, CARY(AD_MAGM),
      INVIS, A_LAWFUL, PM_ARCHEOLOGIST, NON_PM, 2500L),

    A("The Heart of Ahriman", LUCKSTONE,
      (SPFX_NOGEN | SPFX_RESTR | SPFX_INTEL), SPFX_STLTH, ALL_MTYP,
    ...
    A("The Sceptre of Might", MACE,
      ...
      MTYP(MTYP_ALIGN, (AM_NEUTRAL | AM_CHAOTIC | AM_UNALIGNED)),
      PHYS(5, 0), NO_DFNS, CARY(AD_MAGM),
      CONFLICT, A_LAWFUL, PM_CAVEMAN, NON_PM, 2500L),

    A("The Staff of Aesculapius", QUARTERSTAFF,
      (SPFX_NOGEN | SPFX_RESTR | SPFX_INTEL | SPFX_REGEN), 0, ALL_MTYP,
      DRLI(0, 0), DRLI(0, 0), NO_CARY,
      HEALING, A_NEUTRAL, PM_HEALER, NON_PM, 5000L),

    A("The Magic Mirror of Merlin", MIRROR,
      (SPFX_NOGEN | SPFX_RESTR | SPFX_INTEL | SPFX_SPEAK), SPFX_ESP, NO_MTYP,
      NO_ATTK, NO_DFNS, CARY(AD_MAGM),
      0, A_LAWFUL, PM_KNIGHT, NON_PM, 1500L),

    A("The Eyes of the Overworld", LENSES,
      (SPFX_NOGEN | SPFX_RESTR | SPFX_INTEL | SPFX_XRAY), 0, NO_MTYP,
      NO_ATTK, NO_DFNS, CARY(AD_MAGM),
    ...
    A("The Longbow of Diana", BOW,
      (SPFX_NOGEN | SPFX_RESTR | SPFX_INTEL), (SPFX_REFLECT | SPFX_ESP), ALL_MTYP,
      PHYS(5, 0), NO_DFNS, NO_CARY,
      CREATE_AMMO, A_CHAOTIC, PM_RANGER, NON_PM, 4000L),

    A("The Master Key of Thievery", SKELETON_KEY,
      (SPFX_NOGEN | SPFX_RESTR | SPFX_INTEL | SPFX_SPEAK),
      (SPFX_WARN | SPFX_TCTRL | SPFX_HPHDAM), NO_MTYP,
      NO_ATTK, NO_DFNS, NO_CARY,
      UNTRAP, A_CHAOTIC, PM_ROGUE, NON_PM, 3500L),

    A("The Tsurugi of Muramasa", TSURUGI,
      (SPFX_NOGEN | SPFX_RESTR | SPFX_INTEL | SPFX_BEHEAD | SPFX_LUCK), 0, ALL_MTYP,
    ...
    A("The Orb of Fate", CRYSTAL_BALL,
      ...
      (SPFX_WARN | SPFX_HSPDAM | SPFX_HPHDAM), NO_MTYP,
      NO_ATTK, NO_DFNS, NO_CARY,
      LEV_TELE, A_NEUTRAL, PM_VALKYRIE, NON_PM, 3500L),

    A("The Eye of the Aethiopica", AMULET_OF_ESP,
      (SPFX_NOGEN | SPFX_RESTR | SPFX_INTEL), (SPFX_EREGEN | SPFX_HSPDAM), NO_MTYP,
      NO_ATTK, NO_DFNS, CARY(AD_MAGM),
 ...
 */
    A(0, 0, 0, 0, NO_MTYP, NO_ATTK, NO_DFNS, NO_CARY, 0, A_NONE, NON_PM, NON_PM, 0L)
