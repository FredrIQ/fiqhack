...
# define MAX_PET_CHAIN  8       /* don't allow pet chains bigger than this */
...
struct distmap_state {
    ...
    boolean goodpos_cached[COLNO][ROWNO];
    boolean goodpos[COLNO][ROWNO];
...
# define MM_PLAYERMONST   0x10000 /* making player monster */
# define MM_SUMMON        0x20000 /* making summoned monster */
