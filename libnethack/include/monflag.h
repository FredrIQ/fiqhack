...
# define MS_CUSS		29
                                /* berates (demons) or intimidates (Wiz) */
...
# define MS_SELL		34
                                /* demand payment, complain about shoplifters */
