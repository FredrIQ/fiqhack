...
# define S_sw_tl		0
                                /* swallow top left [1] */
# define S_sw_tc		1
                                /* swallow top center [2] Order: */
# define S_sw_tr		2
                                /* swallow top right [3] */
# define S_sw_ml		3
                                /* swallow middle left [4] 1 2 3 */
# define S_sw_mr		4
                                /* swallow middle right [6] 4 5 6 */
# define S_sw_bl		5
                                /* swallow bottom left [7] 7 8 9 */
# define S_sw_bc		6
                                /* swallow bottom center [8] */
# define S_sw_br		7
                                /* swallow bottom right [9] */
