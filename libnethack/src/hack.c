...
check_special_room(boolean newlev)
{
    ...
    for (ptr = &u.uentered[0]; *ptr; ptr++) {
        ...
        case DELPHI:
            ...
            break;
        case DEMONDEN:
            pline(msgc_levelsound, "You enter a hideous den!");
            break;
        case SUBMERGED:
            pline(msgc_levelsound, "You enter a flooded room!");
            break;
        case ABBATOIR:
            pline(msgc_levelsound, "You enter a horrific slaughterhouse!");
            break;
        case TEMPLE:
        case SEMINARY:
