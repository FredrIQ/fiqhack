...
/* HP/Pw advancement structs */
#define ADVS(hpadv,enadv) hpadv,enadv
#define ADV(init,a4,a7,a10,a13,a16,a19,a22,a25) \
    {init,a4,a7,a10,a13,a16,a19,a22,a25}

#define NOADV ADVS(HPADV, ENADV)
 ...
 * Use AMON() if you need custom HP/Pw advancement, AFMON for FMON equivalent.
 */
#define MON(nam,sym,lvl,gen,atk,siz,mr1,mr2,flg1,flg2,flg3,mp,col)      \
    {nam,nam,sym,lvl,gen,atk,siz,flg1,flg2,flg3,mp,NOADV,mr1,mr2,col}
 ...
 */
    ...
    AMON("dwarf", S_HUMANOID,
         ...
         ADVS(ADV(4, 1, 2, 3, 4, 5, 6, 6, 7),
              ADV(0, 0, 0, 0, 1, 1, 1, 2, 2)), CLR_RED),
 ...
 */
    ...
    AMON("kobold shaman", S_KOBOLD,
         ...
         M3_LINEUP,
         MP_WAND_BASIC | MP_SATK_BASIC | MP_SESC_BASIC,
 ...
 */
    ...
    AMON("orc", S_ORC,
         ...
         M3_INFRAVISIBLE | M3_INFRAVISION, 0,
         ADVS(ADV(3, 1, 2, 3, 3, 4, 5, 5, 6),
              ADV(1, 1, 1, 1, 2, 2, 2, 3, 3)), CLR_RED),
    MON("hill orc", S_ORC,
    ...
    AMON("orc shaman", S_ORC,
         ...
         M3_INFRAVISIBLE | M3_INFRAVISION | M3_SPELLCASTER |
         M3_LINEUP,
         MP_WAND_BASIC | MP_SATK_BASIC | MP_SENC_BASIC,
         ADVS(HPADV, SPADV), HI_ZAP),
 ...
 */
    ...
    AMON("ki-rin", S_ANGEL,
         ...
         MP_SENC_BASIC | MP_SCLC_EXPERT | MP_SESC_SKILLED | MP_SMAT_BASIC,
         ADVS(HPADV, SPADV), HI_GOLD),
    AMON("Archon", S_ANGEL,
         ...
         MP_SENC_SKILLED | MP_SCLC_EXPERT | MP_SESC_SKILLED | MP_SMAT_BASIC,
         ADVS(HPADV, SPADV), HI_LORD),
/*
 * Bats
 */
    MON("bat", S_BAT,
 ...
 */
    ...
    AMON("gray dragon", S_DRAGON,
         ...
         M2_MAGIC, 0, 0,
         ADVS(ADV(4, 1, 3, 5, 7, 9, 11, 12, 14),
              ADV(3, 1, 2, 3, 4, 5, 6, 7, 8)), CLR_GRAY | HI_ULINE),
    AMON("silver dragon", S_DRAGON,
         LVL(15, 20, -1, 20, 4), (G_GENO | 1),
         ...
         M2_MAGIC, 0, 0,
         ADVS(ADV(4, 1, 3, 5, 7, 9, 11, 12, 14),
              ADV(3, 1, 2, 3, 4, 5, 6, 7, 8)), DRAGON_SILVER | HI_ULINE),
    AMON("shimmering dragon", S_DRAGON,
         LVL(15, 20, -1, 20, 4), (G_GENO | 1),
         ...
         M1_CARNIVORE,
         M2_HOSTILE | M2_STALK | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS |
         M2_MAGIC, M3_DISPLACED, 0,
         ADVS(ADV(4, 1, 3, 5, 7, 9, 11, 12, 14),
              ADV(3, 1, 2, 3, 4, 5, 6, 7, 8)), CLR_CYAN | HI_ULINE),
    AMON("red dragon", S_DRAGON,
         LVL(15, 20, -1, 20, -4), (G_GENO | 1),
         ...
         M1_CARNIVORE,
         M2_HOSTILE | M2_STALK | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS |
         M2_MAGIC, M3_INFRAVISIBLE, 0,
         ADVS(ADV(4, 1, 3, 5, 7, 9, 11, 12, 14),
              ADV(3, 1, 2, 3, 4, 5, 6, 7, 8)), CLR_RED | HI_ULINE),
    AMON("white dragon", S_DRAGON,
         ...
         M2_MAGIC, 0, 0,
         ADVS(ADV(4, 1, 3, 5, 7, 9, 11, 12, 14),
              ADV(3, 1, 2, 3, 4, 5, 6, 7, 8)), CLR_WHITE | HI_ULINE),
    AMON("orange dragon", S_DRAGON,
         LVL(15, 20, -1, 20, 5), (G_GENO | 1),
         ...
         M2_MAGIC, 0, 0,
         ADVS(ADV(4, 1, 3, 5, 7, 9, 11, 12, 14),
              ADV(3, 1, 2, 3, 4, 5, 6, 7, 8)), CLR_ORANGE | HI_ULINE),
    AMON("black dragon", S_DRAGON,
         ...
         M2_MAGIC, 0, 0,
         ADVS(ADV(4, 1, 3, 5, 7, 9, 11, 12, 14),
              ADV(3, 1, 2, 3, 4, 5, 6, 7, 8)), CLR_BLACK | HI_ULINE),
    AMON("blue dragon", S_DRAGON,
         ...
         M2_MAGIC, 0, 0,
         ADVS(ADV(4, 1, 3, 5, 7, 9, 11, 12, 14),
              ADV(3, 1, 2, 3, 4, 5, 6, 7, 8)), CLR_BRIGHT_BLUE | HI_ULINE),
    AMON("green dragon", S_DRAGON,
         LVL(15, 20, -1, 20, 6), (G_GENO | 1),
         ...
         M2_MAGIC, 0, 0,
         ADVS(ADV(4, 1, 3, 5, 7, 9, 11, 12, 14),
              ADV(3, 1, 2, 3, 4, 5, 6, 7, 8)), CLR_GREEN | HI_ULINE),
    AMON("yellow dragon", S_DRAGON,
         LVL(15, 20, -1, 20, 7), (G_GENO | 1),
         ...
         M2_MAGIC, 0, 0,
         ADVS(ADV(4, 1, 3, 5, 7, 9, 11, 12, 14),
              ADV(3, 1, 2, 3, 4, 5, 6, 7, 8)), CLR_YELLOW | HI_ULINE),
/*
 * Elementals
 */
 ...
 */
    AMON("gnome", S_GNOME,
         ...
         M3_INFRAVISIBLE | M3_INFRAVISION, 0,
         ADVS(ADV(1, 1, 1, 1, 2, 2, 3, 3, 4),
              ADV(2, 1, 2, 2, 3, 3, 4, 4, 5)), CLR_BROWN),
    ...
    AMON("gnomish wizard", S_GNOME,
         ...
         M3_INFRAVISIBLE | M3_INFRAVISION | M3_SPELLCASTER |
         M3_LINEUP,
         MP_WAND_BASIC | MP_SATK_BASIC | MP_SCLC_BASIC,
         ADVS(HPADV, SPADV), HI_ZAP),
 ...
 */
    AMON("lich", S_LICH,
         ...
         MP_SCLC_BASIC,
         ADVS(HPADV, SPADV), CLR_BROWN),
    AMON("demilich", S_LICH,
         ...
         ADVS(HPADV, SPADV), CLR_RED),
    AMON("master lich", S_LICH,
         ...
         MP_SENC_SKILLED | MP_SCLC_SKILLED | MP_SESC_BASIC,
         ADVS(HPADV, SPADV), HI_LORD),
    AMON("arch-lich", S_LICH,
         ...
         ADVS(HPADV, SPADV), CLR_BRIGHT_MAGENTA),
/*
 * Mummies
 */
 ...
 */
    ...
    AMON("golden naga", S_NAGA,
         ...
         ADVS(HPADV, SPADV), HI_GOLD | HI_ULINE),
 ...
 */
    AMON("barrow wight", S_WRAITH,
         ...
         MP_WAND_BASIC | MP_SENC_BASIC | MP_SESC_BASIC,
         ADVS(HPADV, SPADV), CLR_GRAY),
    MON("wraith", S_WRAITH,
 ...
 */
    AMON("human", S_HUMAN,
         ...
         M3_INFRAVISIBLE, 0,
         ADVS(ADV(2, 1, 2, 2, 3, 3, 4, 4, 5),
              ADV(1, 1, 1, 2, 2, 3, 3, 3, 4)), HI_DOMESTIC2),
    MON("wererat", S_HUMAN,
        LVL(2, 12, 10, 10, -7), (1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    AMON("elf", S_HUMAN,
         ...
         MP_WAND_BASIC,
         ADVS(ADV(0, 0, 0, 1, 1, 1, 2, 2, 3),
              ADV(3, 1, 2, 3, 4, 4, 5, 5, 6)), CLR_GREEN),
    ...
    AFMON("aligned priest", "aligned priestess", S_HUMAN,
          ...
          MP_SCLC_SKILLED,
          ADVS(HPADV, SPADV), CLR_YELLOW),
    AFMON("high priest", "high priestess", S_HUMAN,
          ...
          MP_SENC_SKILLED | MP_SCLC_EXPERT | MP_SESC_BASIC,
          ADVS(HPADV, SPADV), CLR_YELLOW | HI_ULINE),
    MON("soldier", S_HUMAN,
 ...
 */
    ...
    MON("pit fiend", S_DEMON,
        LVL(15, 12, -3, 65, -13), (G_HELL | G_NOCORPSE | 2),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION,
        MP_WAND_SKILLED | MP_SATK_SKILLED | MP_SHEA_BASIC | MP_SDIV_SKILLED |
        MP_SENC_SKILLED | MP_SCLC_EXPERT | MP_SESC_BASIC | MP_SMAT_SKILLED,
        HI_LORD),
    MON("balrog", S_DEMON,
    ...
    AMON("Orcus", S_DEMON,
         ...
         MP_SENC_EXPERT | MP_SCLC_EXPERT | MP_SESC_SKILLED,
         ADVS(HPADV, SPADV), CLR_BRIGHT_MAGENTA),
    MON("Geryon", S_DEMON,
 ...
 */
    AMON("archeologist", S_HUMAN,
         ...
         ADVS(ADV(11, 1, 1, 2, 3, 3, 4, 4, 5),
              ADV(1, 0, 0, 1, 1, 2, 2, 3, 4)), HI_DOMESTIC3),
    AMON("barbarian", S_HUMAN,
         LVL(10, 12, 10, 1, 0), 1,
         A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6),
           NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
         ...
         MP_SATK_SKILLED,
         ADVS(ADV(14, 1, 2, 3, 4, 5, 6, 7, 8),
              ADV(1, 0, 0, 0, 0, 0, 1, 1, 1)), HI_DOMESTIC3),
    AFMON("caveman", "cavewoman", S_HUMAN,
          LVL(10, 12, 10, 0, 1), 1,
          A(ATTK(AT_WEAP, AD_PHYS, 2, 4),
            NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
          SIZ(WT_HUMAN, 400, 0, MS_HUMANOID, MZ_HUMAN), 0, 0,
          ...
          M2_NOPOLY | M2_HUMAN | M2_STRONG | M2_COLLECT,
          M3_INFRAVISIBLE,
          MP_WAND_BASIC | MP_SATK_BASIC | MP_SMAT_SKILLED,
          ADVS(ADV(14, 1, 2, 2, 3, 4, 5, 5, 6),
               ADV(1, 0, 0, 0, 1, 1, 2, 2, 3)), HI_DOMESTIC3),
    AMON("healer", S_HUMAN,
         LVL(10, 12, 10, 1, 0), 1,
         A(ATTK(AT_WEAP, AD_PHYS, 1, 6),
           NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
         ...
         M2_NOPOLY | M2_HUMAN | M2_STRONG | M2_COLLECT,
         M3_INFRAVISIBLE | M3_SPELLCASTER,
         MP_WAND_EXPERT | MP_SHEA_EXPERT,
         ADVS(ADV(18, 1, 1, 2, 3, 4, 5, 5, 6),
              ADV(4, 0, 1, 1, 2, 3, 3, 4, 5)), HI_DOMESTIC3),
    AMON("knight", S_HUMAN,
         LVL(10, 12, 10, 1, 3), 1,
         A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6),
           NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
         ...
         ADVS(ADV(14, 1, 2, 2, 3, 4, 5, 5, 6),
              ADV(1, 0, 1, 2, 3, 3, 4, 5, 6)), HI_DOMESTIC3),
    AMON("monk", S_HUMAN,
         LVL(10, 12, 10, 2, 0), 1,
         ...
         ADVS(ADV(12, 1, 1, 1, 2, 3, 4, 4, 5),
              ADV(2, 1, 2, 3, 4, 5, 6, 6, 7)), HI_DOMESTIC3),
    AFMON("priest", "priestess", S_HUMAN,
          LVL(10, 12, 10, 2, 1), 1,
          A(ATTK(AT_WEAP, AD_PHYS, 1, 6),
            NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
          SIZ(WT_HUMAN, 400, 0, MS_HUMANOID, MZ_HUMAN), 0, 0,
          ...
          ADVS(ADV(12, 1, 1, 1, 2, 2, 3, 4, 5),
               ADV(4, 1, 2, 3, 4, 5, 6, 7, 8)), HI_DOMESTIC3),
    AMON("ranger", S_HUMAN,
         LVL(10, 12, 10, 2, -3), 1,
         A(ATTK(AT_WEAP, AD_PHYS, 1, 4),
           NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    AMON("rogue", S_HUMAN,
         ...
         MP_SESC_SKILLED | MP_SMAT_SKILLED,
         ADVS(ADV(10, 0, 1, 1, 1, 2, 2, 3, 4),
              ADV(1, 0, 1, 1, 2, 3, 3, 4, 5)), HI_DOMESTIC3),
    AMON("samurai", S_HUMAN,
         LVL(10, 12, 10, 1, 3), 1,
         ...
         MP_WAND_SKILLED | MP_SATK_SKILLED | MP_SCLC_SKILLED,
         ADVS(ADV(13, 1, 1, 2, 2, 3, 4, 5, 6),
              ADV(1, 0, 0, 0, 0, 1, 1, 1, 2)), HI_DOMESTIC3),
    AMON("tourist", S_HUMAN,
         LVL(10, 12, 10, 1, 0), 1,
         A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6),
           NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
         SIZ(WT_HUMAN, 400, 0, MS_HUMANOID, MZ_HUMAN), 0, 0,
         ...
         ADVS(ADV(8, 0, 0, 1, 1, 2, 2, 2, 3),
              ADV(1, 0, 0, 1, 2, 3, 4, 5, 6)), HI_DOMESTIC3),
    AMON("valkyrie", S_HUMAN,
         LVL(10, 12, 10, 1, 0), 1,
         A(ATTK(AT_WEAP, AD_PHYS, 1, 8), ATTK(AT_WEAP, AD_PHYS, 1, 8),
           NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
         ...
         MP_WAND_SKILLED | MP_SATK_BASIC | MP_SESC_BASIC,
         ADVS(ADV(14, 1, 1, 2, 2, 3, 4, 5, 6),
              ADV(1, 0, 0, 0, 1, 1, 1, 2, 2)), HI_DOMESTIC3),
    AMON("wizard", S_HUMAN,
         LVL(10, 12, 10, 3, 0), 1,
         A(ATTK(AT_WEAP, AD_PHYS, 1, 6),
           NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
         ...
         ADVS(ADV(10, 0, 0, 1, 1, 2, 2, 3, 4),
              ADV(4, 1, 2, 4, 5, 6, 7, 8, 9)), HI_DOMESTIC3),
 ...
 */
    ...
    AMON("Grand Master", S_HUMAN,
         ...
         MP_WAND_EXPERT | MP_SATK_BASIC | MP_SHEA_SKILLED | MP_SDIV_EXPERT |
         MP_SENC_SKILLED | MP_SCLC_EXPERT | MP_SESC_BASIC,
         ADVS(HPADV, SPADV), HI_QUEST),
    AMON("Arch Priest", S_HUMAN,
    ...
    MON("Norn", S_HUMAN,
        ...
        | M2_MAGIC,
        M3_CLOSE | M3_INFRAVISIBLE, MP_WAND_SKILLED, HI_QUEST),
    AMON("Neferet the Green", S_HUMAN,
         ...
         ADVS(HPADV, SPADV), CLR_BRIGHT_GREEN),
/*
 * quest nemeses
 */
    AMON("Minion of Huhetotl", S_DEMON,
         ...
         MP_SCLC_BASIC | MP_SESC_SKILLED,
         ADVS(HPADV, SPADV), HI_QUEST),
    AMON("Thoth Amon", S_HUMAN,
    ...
    AMON("Chromatic Dragon", S_DRAGON,
         ...
         M3_WANTSARTI | M3_WAITFORU | M3_INFRAVISIBLE | M3_SPELLCASTER |
         M3_LINEUP,
         MP_SHEA_BASIC | MP_SENC_BASIC | MP_SESC_SKILLED,
         ADVS(ADV(4, 1, 3, 5, 7, 9, 11, 12, 14),
              SPADV), HI_QUEST),
    MON("Cyclops", S_GIANT,
 ...
 */
    ...
    AMON("abbot", S_HUMAN,
         ...
         M2_NOPOLY | M2_HUMAN | M2_PEACEFUL | M2_STRONG | M2_COLLECT,
         M3_INFRAVISIBLE | M3_SPELLCASTER,
         MP_WAND_SKILLED | MP_SDIV_BASIC | MP_SCLC_SKILLED,
         ADVS(HPADV, SPADV), HI_GUARDIAN),
    AMON("acolyte", S_HUMAN,
         LVL(5, 12, 10, 20, 0), G_NOGEN,
         A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
           NO_ATTK),
         SIZ(WT_HUMAN, 400, 0, MS_GUARDIAN, MZ_HUMAN), 0, 0,
         ...
         M2_NOPOLY | M2_HUMAN | M2_PEACEFUL | M2_STRONG | M2_COLLECT,
         M3_INFRAVISIBLE | M3_SPELLCASTER,
         MP_WAND_SKILLED | MP_SHEA_BASIC | MP_SCLC_SKILLED,
         ADVS(HPADV, SPADV), HI_GUARDIAN),
    MON("hunter", S_HUMAN,
    ...
    AMON("guide", S_HUMAN,
         ...
         M2_NOPOLY | M2_HUMAN | M2_PEACEFUL | M2_STRONG | M2_COLLECT | M2_MAGIC,
         M3_INFRAVISIBLE | M3_SPELLCASTER,
         MP_WAND_SKILLED | MP_SHEA_BASIC | MP_SCLC_BASIC |MP_SESC_BASIC,
         ADVS(HPADV, SPADV), HI_GUARDIAN),
    MON("warrior", S_HUMAN,
        LVL(5, 12, 10, 10, -1), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), ATTK(AT_WEAP, AD_PHYS, 1, 8),
    ...
    AMON("apprentice", S_HUMAN,
         ...
         M2_NOPOLY | M2_HUMAN | M2_PEACEFUL | M2_STRONG | M2_COLLECT | M2_MAGIC,
         M3_INFRAVISIBLE | M3_SPELLCASTER,
         MP_WAND_SKILLED | MP_SATK_SKILLED | MP_SENC_SKILLED,
         ADVS(HPADV, SPADV), HI_GUARDIAN),
/*
 * array terminator
 */
