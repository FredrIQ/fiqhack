...
void m_throw(struct monst *mon, int x, int y, int dx, int dy,
	     int range, struct obj *obj, boolean verbose)
{
	struct monst *mtmp;
...
struct monst * mfind_target(struct monst *mtmp)
{
...
boolean mlined_up(struct monst *mtmp, struct monst *mdef, boolean breath)
{
	struct monst *mat;
