...
static const struct nh_option_desc const_options[] = {
    ...
    {"corridorbranch", "Commands and Confirmations",
     "if true, don't stop on branching corridors",
     nh_birth_ingame, OPTTYPE_BOOL, {.b = TRUE}},
    ...
    {"display_turns", "Messages and Menus",
     "whether to display [N turns] for actions taking 2+ turns",
     nh_birth_ingame, OPTTYPE_BOOL, {.b = TRUE}},
    ...
    {"catname", "Personalization",
     ...
     nh_birth_creation, OPTTYPE_STRING, {.s = ""}},
