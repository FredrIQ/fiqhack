...
const struct Role roles[] = {
    ...
    {{"Healer", 0}, {
     ...
     10, 3, -3, 2, 10, A_WIS, SPE_CREATE_FAMILIAR, -4},
    {{"Knight", 0}, {
                     {"Gallant", 0},
                     {"Esquire", 0},
                     {"Bachelor", 0},
     ...
     10, 8, -2, 0, 9, A_WIS, SPE_MAGIC_MISSILE, -4},
    {{"Monk", 0}, {
                   {"Candidate", 0},
                   {"Novice", 0},
                   {"Initiate", 0},
     ...
     10, 8, -2, 2, 20, A_WIS, SPE_CANCELLATION, -4},
    {{"Priest", "Priestess"}, {
                               {"Aspirant", 0},
                               {"Acolyte", 0},
                               {"Adept", 0},
    ...
    {{"Ranger", 0}, {
     ...
     10, 9, 2, 1, 10, A_INT, SPE_SPEED_MONSTER, -4},
    {{"Samurai", 0}, {
     ...
     {1, 0, 0, 1, 0, 1}, 11,    /* Energy */
     10, 10, 0, 0, 8, A_INT, SPE_CONFUSE_MONSTER, -4},
    {{"Tourist", 0}, {
                      {"Rambler", 0},
                      {"Sightseer", 0},
                      {"Excursionist", 0},
    ...
    {{"Valkyrie", 0}, {
     ...
     {14, 0, 0, 8, 2, 0},       /* Hit points */
     {1, 0, 0, 1, 0, 1}, 10,    /* Energy */
     10, 10, -2, 0, 9, A_WIS, SPE_DRAIN_LIFE, -4},
    {{"Wizard", 0}, {
                     {"Evoker", 0},
                     {"Conjurer", 0},
                     {"Thaumaturge", 0},
     ...
     0, 1, 0, 3, 10, A_INT, SPE_TELEPORT_AWAY, -4},
/* Array terminator */
    {{0, 0}}
};
