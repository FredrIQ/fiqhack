 ...
 */
boolean
goodpos(struct level *lev, int x, int y, const struct monst *mtmp, unsigned gpflags)
{
...
/* allow_drag: treat as a "jump" or similar and move the ball&chain as such.
   Otherwise, it's simply just teleported next to you. */
void
