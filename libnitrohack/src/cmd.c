...
const struct cmd_desc cmdlist[] = {
	...
	{"countgold", "show gold, debt, credit, and unpaid items", GOLD_SYM, 0, TRUE, doprgold, CMD_ARG_NONE | CMD_NOTIME},
	...
	{"showamulets", "list the amulets in your inventory", AMULET_SYM, 0, TRUE, dopramulet, CMD_ARG_NONE | CMD_NOTIME},
	{"showarmor", "list the armor in your inventory", ARMOR_SYM, 0, TRUE, doprarm, CMD_ARG_NONE | CMD_NOTIME},
	{"showrings", "list the rings in your inventory", RING_SYM, 0, TRUE, doprring, CMD_ARG_NONE | CMD_NOTIME},
	{"showtools", "list the tools in your inventory", TOOL_SYM, 0, TRUE, doprtool, CMD_ARG_NONE | CMD_NOTIME},
	{"showweapon", "list the weapons in your inventory", WEAPON_SYM, 0, TRUE, doprwep, CMD_ARG_NONE | CMD_NOTIME},
	...
	{"version", "displays the version number", 'v', 0, TRUE, doversion, CMD_ARG_NONE | CMD_NOTIME},
	{"verhistory", "display the version history", 'V', 0, TRUE, doverhistory, CMD_HELP | CMD_ARG_NONE | CMD_NOTIME},
