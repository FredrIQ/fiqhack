...
UNCURSED_ANDWINDOWDEF(int, attr_get,
...
UNCURSED_ANDWINDOWDEF(int, attr_off,
                      (attr_t attr, void *unused), (attr, unused)) {
    (void) unused;
    return wattroff(win, attr);
}
UNCURSED_ANDWINDOWDEF(int, attr_on,
                      (attr_t attr, void *unused), (attr, unused)) {
    (void) unused;
    return wattron(win, attr);
}
UNCURSED_ANDWINDOWDEF(int, attr_set,
                      (attr_t attr, void *unused), (attr, unused)) {
    (void) unused;
    return wattrset(win, attr);
}
UNCURSED_ANDMVWINDOWDEF(int, chgat,
                        (int len, attr_t attr, uncursed_color pairnum,
                         const void *unused),
...
UNCURSED_ANDWINDOWDEF(int, border,
...
UNCURSED_ANDWINDOWDEF(int, border_set,
