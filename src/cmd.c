...
const struct cmd_desc cmdlist[] = {
	...
	{"license", "show the NetHack license", 0, 0, TRUE, dolicense, CMD_ARG_NONE | CMD_HELP},
	...
	{"showarmor", "list the armor in your inventory", ARMOR_SYM, 0, TRUE, doprarm, CMD_ARG_NONE},
	{"showrings", "list the rings in your inventory", RING_SYM, 0, TRUE, doprring, CMD_ARG_NONE},
	{"showtools", "list the tools in your inventory", TOOL_SYM, 0, TRUE, doprtool, CMD_ARG_NONE},
	{"showweapon", "list the weapons in your inventory", WEAPON_SYM, 0, TRUE, doprwep, CMD_ARG_NONE},
	{"showworn", "show the items you are wearing", '*', 0, TRUE, doprinuse, CMD_ARG_NONE},
	...
	{"twoweapon", "toggle two-weapon combat", M('2'), 0, FALSE, dotwoweapon, CMD_ARG_NONE | CMD_EXT},
	...
	{"whatis", "describe what a symbol means", '/', 0, TRUE, dowhatis, CMD_HELP | CMD_ARG_NONE},
	...
	{"run nopickup", "run without picking anything up", 'M', 0, FALSE, dorun_nopickup, CMD_ARG_DIR | CMD_MOVE},
	...
	{"lightsources", "(DEBUG) show mobile light sources", 0, 0, TRUE, wiz_light_sources, CMD_ARG_NONE | CMD_DEBUG | CMD_EXT},
	...
	{"timeout", "(DEBUG) look at timeout queue", 0, 0, TRUE, wiz_timeout_queue, CMD_ARG_NONE | CMD_DEBUG | CMD_EXT},
	{"vision", "(DEBUG) show vision array", 0, 0, TRUE, wiz_show_vision, CMD_ARG_NONE | CMD_DEBUG | CMD_EXT},
	{"wish", "(DEBUG) wish for an item", C('w'), 0, TRUE, wiz_wish, CMD_ARG_NONE | CMD_DEBUG},
	{"wmode", "(DEBUG) show wall modes", 0, 0, TRUE, wiz_show_wmodes, CMD_ARG_NONE | CMD_DEBUG | CMD_EXT},
